...
type GovernanceParams struct {
	...
	ProposalDurationOptions     []int64 `json:"proposalDurationOptions,omitempty"`
	VoteDurationOptions         []int64 `json:"voteDurationOptions,omitempty"`
	OrderingDurationOptions     []int64 `json:"orderingDurationOptions,omitempty"`
